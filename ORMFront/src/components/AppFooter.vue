<template>
  <v-footer height="56" app>
    ...
    >
      &copy; 2024-{{ (new Date()).getFullYear() }} <span class="d-none d-sm-inline-block">Ohio Railway Museum. All rights reserved.</span>
      <!-- —
      <a
  ...
  const items = [
    {
      title: 'Facebook',
      icon: `mdi-facebook`,
      href: 'https://www.facebook.com/Ohio-Railway-Museum-119071661606/timeline/',
    },
    {
      title: 'Instagram',
      icon: 'mdi-instagram',
      href: 'https://www.instagram.com/ohiorailwaymuseum',
    },
    // {
    //   title: 'Vuetify X',
